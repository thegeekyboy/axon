...
exec_program(hadoop ARGS envvars OUTPUT_VARIABLE HADOOP_ENVLIST RETURN_VALUE BLAH)
string(REPLACE "'" "" HADOOP_ENVLIST "${HADOOP_ENVLIST}")
string(REGEX REPLACE "\n" ";" HADOOP_ENVLIST "${HADOOP_ENVLIST}")
foreach(X IN LISTS HADOOP_ENVLIST)
  string(REPLACE "=" ";" HV ${X})
  list(GET HV 0 HV_NAME)
  list(GET HV 1 HV_VALUE)

  if (HV_NAME STREQUAL "HADOOP_COMMON_LIB_NATIVE_DIR")
    set(HADOOP_COMMON_LIB_NATIVE_DIR "${HV_VALUE}")
  endif()

  if (HV_NAME STREQUAL "HADOOP_COMMON_HOME")
    set(HADOOP_COMMON_HOME "${HV_VALUE}")
  endif()
...
set(HDFS_LIB_PATHS ${HADOOP_COMMON_HOME}/${HADOOP_COMMON_LIB_NATIVE_DIR})
