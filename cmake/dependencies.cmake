...
# 	list(APPEND LIST_LIBRARIES ${LIBASAN_PATH})
# 	message(STATUS "ASAN: ${LIBASAN_PATH}")
	# add_compile_options(-fsanitize=address)
	# add_link_options(-fsanitize=address)
# else (NOT LIBMAGIC_FOUND)
# 	message(FATAL_ERROR "libasan: could not detect/find any installed location, cannot continue")
# endif ()
...
# scylla-cpp-driver
pkg_check_modules(SCYLLADB scylla-cpp-driver)

if (SCYLLADB_FOUND)
	list(APPEND INCLUDE_DIRS ${SCYLLADB_INCLUDE_DIRS})
	# list(APPEND LINK_LIBRARIES ${SCYLLADB_LINK_LIBRARIES})
	list(APPEND LDFLAGS ${SCYLLADB_LDFLAGS})
	list(APPEND LIST_LIBRARIES ${SCYLLADB_MODULE_NAME})
else (NOT SCYLLADB_FOUND)
	# message(STATUS "scylla-cpp-driver: trying alternate search method")
	# find_package(SCYLLADB REQUIRED scylla-cpp-driver)
	# if (SCYLLADB_FOUND)
	# 	list(APPEND INCLUDE_DIRS ${SCYLLADB_INCLUDE_DIRS})
	# 	list(APPEND LINK_LIBRARIES ${SCYLLADB_LIBRARIES})
	# else (NOT SCYLLADB_FOUND)
		message(FATAL_ERROR "scylla-cpp-driver: could not detect/find the required libraries, cannot continue!")
	# endif()
endif()
...
if (RABBITMQ_FOUND)
	list(APPEND INCLUDE_DIRS ${RABBITMQ_INCLUDE_DIRS})
	list(APPEND LINK_LIBRARIES ${RABBITMQ_LINK_LIBRARIES})
	list(APPEND LDFLAGS ${RABBITMQ_LDFLAGS})
else (NOT RABBITMQ_FOUND)
	message(FATAL_ERROR "rabbitmq: could not detect/find the required libraries, cannot continue!")
endif ()
