...
list(APPEND RPM_DEPENDENCY "libstdc++")
...
if (CRYPT_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "openssl-libs")
...
if (LIBMAGIC_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "file-libs")
...
if (OPENSSL_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "openssl")
endif ()
...
if (KRB5_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "krb5-libs")
else (NOT KRB5_FOUND)
...
if (CURL_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libcurl")
else (NOT CURL_FOUND)
...
if (BZIP2_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "bzip2-libs")
...
if (ZSTD_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libzstd")
else (NOT ZSTD_FOUND)
...
if (SQLITE3_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "sqlite-libs")
...
if (SSH2_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libssh2")
...
if (CONFIG_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libconfig")
...
if (BLKID_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libblkid")
...
if (SMB2_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libsmb2")
	#list(APPEND LIST_DEPS_SCRIPT "libsmb2")
else (NOT SMB2_FOUND)
...
if (RDKAFKA_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "librdkafka1")
...
if (AVRO_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "avro-c")
	# list(APPEND LIST_DEPS_SCRIPT " avro-c")
else (NOT AVRO_FOUND)
...
if (SERDES_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "libserdes")
	# list(APPEND LIST_DEPS_SCRIPT " serdes")
...
if (SCYLLADB_FOUND)
	...
	list(APPEND RPM_DEPENDENCY "scylla-cpp-driver")
	# list(APPEND LIST_DEPS_SCRIPT "scylla-cpp-driver")
endif()
...
if (AWSSDK_FOUND)
	...
	# list(APPEND RPM_DEPENDENCY "aws-c-common")
	# list(APPEND RPM_DEPENDENCY "aws-c-s3")
	list(APPEND RPM_DEPENDENCY "aws-c-sdk")
	# list(APPEND LIST_DEPS_SCRIPT " aws-cpp-sdk-s3")
else (NOT AWSSDK_FOUND)
	message(STATUS "aws-c-s3: trying alternate search method")
	# find_package(AWSSDK REQUIRED COMPONENTS s3)
	find_package(aws-c-s3)
	if (aws-c-s3_FOUND)
		list(APPEND INCLUDE_DIRS ${aws-c-s3_INCLUDE_DIRS})
		list(APPEND LINK_LIBRARIES ${aws-c-s3_LINK_LIBRARIES})
	else (NOT aws-c-s3_FOUND)
...
# libsasl2
pkg_check_modules(SASL2 REQUIRED libsasl2>=2.1.27)

if (SASL2_FOUND)
	list(APPEND INCLUDE_DIRS ${SASL2_INCLUDEDIR})
	list(APPEND LINK_LIBRARIES ${SASL2_LINK_LIBRARIES})
	list(APPEND LDFLAGS ${SASL2_LDFLAGS})
	list(APPEND RPM_DEPENDENCY "cyrus-sasl-devel")
else (NOT SASL2_FOUND)
	message(STATUS "libsasl2: trying alternate search method")
	find_package(SASL2 REQUIRED)
	if (SASL2_FOUND)
		list(APPEND INCLUDE_DIRS ${SASL2_INCLUDE_DIRS})
		list(APPEND LINK_LIBRARIES ${SASL2_LIBRARIES})
	else (NOT SASL2_FOUND)
		message(FATAL_ERROR "libsasl2: could not detect/find the required libraries, cannot continue!")
	endif ()
endif ()

# ldap
pkg_check_modules(LDAP REQUIRED ldap>=2.6.6) 

if (LDAP_FOUND)
	add_definitions( -DLDAP_INCLUDEDIR=${LDAP_INCLUDEDIR} )
	list(APPEND INCLUDE_DIRS ${LDAP_INCLUDEDIR})
	list(APPEND LINK_LIBRARIES ${LDAP_LINK_LIBRARIES})
	list(APPEND LDFLAGS ${LDAP_LDFLAGS})
	list(APPEND RPM_DEPENDENCY "openldap")
else (NOT LDAP_FOUND)
	message(STATUS "ldap: trying alternate search method")
	find_package(LDAP REQUIRED)
	if (LDAP_FOUND)
		list(APPEND INCLUDE_DIRS ${LDAP_INCLUDE_DIRS})
		list(APPEND LINK_LIBRARIES ${LDAP_LIBRARIES})
	else (NOT LDAP_FOUND)
		message(FATAL_ERROR "ldap: could not detect/find the required libraries, cannot continue!")
	endif ()
endif ()
...
if (ORACLE_FOUND)
	...
	list(APPEND INCLUDE_DIR_FLAGS "-I${ORACLE_INCLUDE_DIRS}")
	list(APPEND RPM_DEPENDENCY "oracle-instantclient-basic")
...
if (HDFS3_FOUND)
	...
	list(APPEND INCLUDE_DIR_FLAGS "-I${HDFS3_INCLUDE_DIR}")
	list(APPEND RPM_DEPENDENCY "libhdfs3")
...
list(REMOVE_DUPLICATES INCLUDE_DIR_FLAGS)
list(REMOVE_DUPLICATES LIST_MODULE_NAME)
list(REMOVE_DUPLICATES INCLUDE_DIR_FLAGS)
list(REMOVE_DUPLICATES RPM_DEPENDENCY)

string (REPLACE ";" " " STR_INCLUDE_DIR_FLAGS "${INCLUDE_DIR_FLAGS}")
string (REPLACE ";" " " STR_LIBRARIES "${LIST_MODULE_NAME}")
string (REPLACE ";" " " STR_LDFLAGS "${LDFLAGS}")
string (REPLACE ";" " " STR_RPM_DEPENDENCY "${RPM_DEPENDENCY}")
...
# removeDuplicateSubstring(${RPM_DEPENDENCY} RPM_DEPENDENCY)
